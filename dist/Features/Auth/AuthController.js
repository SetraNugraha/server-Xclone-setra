...
const register = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      (0,
      validateError_1.validateInput)(!emailRegex.test(email), "email", "Invalid format email");
      (0,
      validateError_1.validateInput)(password.length < 6, "password", "Password must be greater than 6 characters");
      (0,
      validateError_1.validateInput)(password !== confirmPassword, "password", "Password do not match");
      // Prepare Data
      const registerData = {
        name: name,
        username: name,
...
const login = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      (0,
      validateError_1.validateInput)(password.length < 6, "password", "Password must be greater than 6 characters");
      const { accessToken, refreshToken } = yield AuthService_1.default.login({
        email,
        password,
      });
